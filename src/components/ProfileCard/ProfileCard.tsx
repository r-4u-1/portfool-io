...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    const pointerLeaveHandler = (event: Event) => {
      if (event instanceof PointerEvent) {
        handlePointerLeave({
          ...event,
          nativeEvent: event,
    ...
    const handleClick = () => {
      ...
      if (
        ...
        typeof (window.DeviceMotionEvent as unknown as { requestPermission?: () => Promise<string> }).requestPermission === 'function'
      ) {
            ...
            {showUserInfo && (
              <div className="pc-user-info">
                ...
                <a
                  ...
                  href="http://linkedin.com/in/raul-basurto-3b570715a"
